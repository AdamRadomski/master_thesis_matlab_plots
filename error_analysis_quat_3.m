...
% without LC
%poses_sts = load('/home/radam/TODOs/Recordings/STS LTS constraint/before/out_pos_STS.txt');
%poses_lts = load('/home/radam/TODOs/Recordings/STS LTS constraint/before/out_pos_LTS.txt');
%pix4d = pix4d(1:1303,:);

% with LC
poses_sts = load('/home/radam/TODOs/Recordings/STS LTS constraint/after/out_pos_STS.txt');
poses_lts = load('/home/radam/TODOs/Recordings/STS LTS constraint/after/out_pos_LTS.txt');
pix4d = pix4d(1:1399,:);
