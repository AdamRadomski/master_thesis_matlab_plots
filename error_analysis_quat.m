...
pix4d = load('/home/radam/tests/extensive_testing/aligned_pix4dUTM_quat.txt'); % DONT TOUCH
pix4d = pix4d(1:1001,:);

% without LC
poses_sts = load('/home/radam/tests/extensive_testing/no_interaction_long_gps/no_internal_lc/aligned_out_pos_STS.txt');
poses_lts_no_lc = load('/home/radam/tests/extensive_testing/no_interaction_long_gps/no_internal_lc/aligned_out_pos_LTS.txt');
poses_sts = poses_sts(1:1001,:);

% with LC 
poses_lts_lc = load('/home/radam/tests/extensive_testing/no_interaction_long_gps/with_internal_lc/aligned_out_pos_LTS.txt');
...
[r1 r2 r3] = quat2angle(quat_err_lts_lc); errors_sts_a_lc = [r1 r2 r3]*180/pi;
...
hold on
plot(timestamps, errors_sts_a_lc(:,1))
hold on
legend('STS','LTS no LC', 'LTS LC')
title('Error Yaw [deg]')
grid on
...
hold on
plot(timestamps, errors_sts_a_lc(:,2))
legend('STS','LTS no LC', 'LTS LC')
...
hold on
plot(timestamps, errors_sts_a_lc(:,3))
legend('STS','LTS no LC', 'LTS LC')
