...
% with LC
poses_sts = load('/home/radam/TODOs/how_often_constrain/pose_con/100/out_pos_STS.txt');
...
drop_num = 1;
pix4d = pix4d(drop_num:end,:);
poses_sts = poses_sts(drop_num:end,:);
poses_lts = poses_lts(drop_num:end,:);
