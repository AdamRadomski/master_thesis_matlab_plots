...
poses_lts_no_lc = load('/home/radam/out_pos_LTS.txt');

poses_sts(:,2:4) = poses_sts(:,2:4)-[464980,5.27226e+06,414.087];
poses_lts_no_lc(:,2:4) = poses_lts_no_lc(:,2:4)-[464980,5.27226e+06,414.087];

latest_start = FindLatest([poses_sts(1,1) poses_lts_no_lc(1,1)]);
earliest_end = FindEarliest([poses_sts(end,1) poses_lts_no_lc(end,1)]);
